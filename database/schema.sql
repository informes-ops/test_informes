...
-- ------------------------------------------------------------
-- Opciones técnicas (memoria del formulario)
-- ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS opciones_tecnicas_personalizadas (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS opciones_tecnicas_por_trabajo (
    id INT AUTO_INCREMENT PRIMARY KEY,
    tipo_equipo VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS salidas_tecnicas_materiales (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- ------------------------------------------------------------
-- Telegram (bot de captura de evidencias)
-- ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS tg_sesion (
