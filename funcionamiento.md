...
| Arquitectura MVC | ⚠️ Parcial | Capa MVC creada en `app/`; vistas legacy pendientes de migración |
...
│  index.php (técnicos)  │  panel.php (supervisores)         │
│  Vistas HTML+CSS+JS embebidas (legacy, en migración)        │
└────────────────────────┬────────────────────────────────────┘
                         │ POST/GET
┌────────────────────────▼────────────────────────────────────┐
│                    CAPA DE CONTROLADORES                     │
│  app/Controllers/                                            │
│    OdooSyncController.php                                    │
│  Endpoints legacy en raíz:                                   │
│    guardar.php, guardar_preinspeccion.php,                   │
│    actualizar_informe.php, mejorar_texto_ia.php, ...         │
└────────────────────────┬────────────────────────────────────┘
                         │
┌────────────────────────▼────────────────────────────────────┐
│                      CAPA DE MODELOS                         │
...
| 3 | Extraer vistas de panel.php a `app/Views/` | ⏳ Pendiente |
| 4 | Extraer vistas de index.php a `app/Views/` | ⏳ Pendiente |
| 5 | Router central (`public/index.php`) | ⏳ Pendiente |
| 6 | Migraciones SQL versionadas | ⏳ Pendiente |
